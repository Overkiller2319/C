...
void inserir(No **pRaiz, int numero, struct pessoa x){
    if(*pRaiz == NULL){
    ...
    if(numero < (*pRaiz)->numero)
        ...
        if (((*pRaiz)->esquerda == NULL) && ((*pRaiz)->direita == NULL)){ // se nao houver filhos
            ...
            if ((*pRaiz)->esquerda == NULL){
                ...
                else{ //maior filho direito da subarvore esquerda.
...
int main (){
    ...
    do{
        ...
        printf("3  MOSTRAR pessoaS EM ORDEM: \n");
        printf("4  MOSTRAR pessoaS EM PRE-ORDEM: \n");
        printf("5  MOSTRA pessoaS EM POS-ORDEM: \n");
        printf("6  CONTAR NOS\n");
